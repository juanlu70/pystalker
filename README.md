...
Around 2005/2006 a tranding analisys program was bindled with Debian Linux distributions, this was the time I discovered Qtstalker.
...
I had a real time trading system made with my own hands shared with free open source software and I was very proud of it, at that time platforms like Trading View didin't exist, also many others that are common today.
...
When I wrote this the project is still in a very early stage, has lots of bugs, many functions are not working and there is a long trip to get the program finished and in the stage of what I would consider finished, but I want to share the code with the communinty and see if there are people interested on the project and able to contribute to it, in the current state it is really usable and can deliver results.


# Running the program

Some parts of this project are C++ to improve speed on the parts that are too slow in python but you don't need to compile anything, I recommend to install LibQT6 libraries (if you still don't have on your Linux system) and create a virtual environment and run the program:
